defmodule Mix.Tasks.ReqLlm.Install.Docs do
  @moduledoc false
...
if Code.ensure_loaded?(Igniter) do
  defmodule Mix.Tasks.ReqLlm.Install do
  ...
  defmodule Mix.Tasks.ReqLlm.Install do
    ...
    def run(_argv) do
      Mix.shell().error("""
      The task 'req_llm.install' requires igniter. Please install igniter and try again.
